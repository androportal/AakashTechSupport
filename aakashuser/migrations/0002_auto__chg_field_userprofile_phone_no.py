...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'aakashuser_userprofile', 'phone_no', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'UserProfile.phone_no'
        db.alter_column(u'aakashuser_userprofile', 'phone_no', self.gf('django.db.models.fields.IntegerField')(max_length=20))
    ...
    models = {
        ...
        u'aakashuser.ticket': {
            ...
            'closed_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 1, 0, 0)'}),
            'created_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 2, 0, 0)'}),
            'duration_for_reply': ('django.db.models.fields.IntegerField', [], {'default': '24'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'overdue_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 3, 0, 0)'}),
            'reopened_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 1, 0, 0)'}),
        ...
        u'aakashuser.userprofile': {
            ...
            'dob': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 2, 0, 0)'}),
            ...
            'phone_no': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20'}),
