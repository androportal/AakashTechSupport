...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aakashuser_userprofile', (
            ...
            ('dob', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 12, 30, 0, 0))),
            ('phone_no', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=20)),
        ...
        db.create_table(u'aakashuser_ticket', (
            ...
            ('created_date_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 30, 0, 0))),
            ('overdue_date_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 31, 0, 0))),
            ('closed_date_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 29, 0, 0))),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('reopened_date_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 29, 0, 0))),
    ...
    models = {
        ...
        u'aakashuser.ticket': {
            ...
            'closed_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 29, 0, 0)'}),
            'created_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 30, 0, 0)'}),
            'duration_for_reply': ('django.db.models.fields.IntegerField', [], {'default': '24'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'overdue_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 31, 0, 0)'}),
            'reopened_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 29, 0, 0)'}),
        ...
        u'aakashuser.userprofile': {
            ...
            'dob': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 30, 0, 0)'}),
            ...
            'netbook_no': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20'}),
            ...
            'phone_no': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '20'}),
